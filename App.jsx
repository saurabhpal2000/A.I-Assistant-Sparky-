...
const App = () => {
  ...
  const handleVoiceCommand = async (command) => {
    ...
    if (command.includes("what is your name")) {
      const response =
        "Hello Sir I'am, Your A.I assistant created by Saurabh pal";
      speakText(response);
  ...
  const handleInputSearch = (e) => {
    ...
    if (!searchQuery.trim()) {
      setInformation("Please enter a search query.");
      speakText("Please enter a search query.");
      return;
    }

    performGoogleSearch(searchQuery);
    setInformation(`Searching for ${searchQuery}`);
  ...
  return (
    <div>
      <div className="voice-assistant">
        ...
        />
        <div>
          <button className="key" onClick={handleInputSearch}>
            search
          </button>
        </div>
      </div>
